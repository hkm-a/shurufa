...
当前版本 **v1.6.0（versionCode 38，2026-08-19）**：PC 侧 M1–M11 路线图全部完成
（v1.2.0 读屏无障碍阶段二追加：候选窗 ITextProvider + UIA 运行时探针）；安卓侧
按搜狗安卓时间线推进：M-A1 键盘形态（v1.3.0）、M-A2 表达与效率（v1.4.0）、
M-A3 无障碍与生僻字（v1.5.0）、M-A4 AI 助手深化（v1.6.0 验收：帮写风格/场景、
快查、书面语化、翻译），路线图见
